...
{
	// Load the texture
	Texture = loadBMP_custom("images/floorN.bmp");

	//Load Object
	bool res = loadOBJ("models/floorNew.obj", vertices, uvs, normals);
...
void Floor::Draw()
{
	...
	glm::mat4 ScalingMatrix = scale(mat4(), vec3(5.0f, 1.0f, 5.0f));
