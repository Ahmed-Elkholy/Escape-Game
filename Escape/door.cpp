...
Door::Door(drawHandler rH, const int nr, const int nc) :numOfRows(nr), numOfCols(nc)
{
	H = rH;
}
...
{
	// Load the texture
	Texture = loadBMP_custom("images/doort3.bmp");
...
void Door::Draw()
{
	...
	glm::mat4 TranslationMatrix = translate(mat4(), vec3((numOfCols - 1)*2.0f, 0.0f, (numOfRows - 2)*2.0f));
